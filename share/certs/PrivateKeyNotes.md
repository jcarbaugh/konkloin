...
unlocked to sign the Konkloin-Qt.app bundle.
...
allowing somebody to distribute a Konkloin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the konkloin-qt.exe file inside the installer had not been tampered with.
